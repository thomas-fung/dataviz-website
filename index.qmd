...
You can find the winning 2024 entires [here](dataviz2024.html).
...
Over two fully catered days on 25 & 26 September 2025, you'll dive into hands-on masterclass to learn how to create dashboards with Quarto (<https://quarto.org/docs/dashboards/>) and Shiny (<https://shiny.posit.co>). *You may be able earn 20 points towards the Global Leadership Program (GLP) (to be confirmed)*.
